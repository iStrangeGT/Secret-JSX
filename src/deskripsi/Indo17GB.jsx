...
const Indo17GB = () => {
  ...
  const handleBuyNow = () => {
    if (!selectedOption) {
      ...
      const orderDetails = {
        productName: "VPS/RDP 17GB 7vCORE",
        price: "RP.350.000",
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            ...
            <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
              <p className="text-2xl font-extrabold text-gray-500 sm:text-3xl">RP.350.000</p>
            </div>
...
<p className="text-gray-700">Note: Breaking Terms of Service Rules? = <span className="text-red-500">RIP GUARANTEE!!</span></p>
      ...
      >
          <div className="bg-white/70 rounded-lg shadow-lg p-6 w-96">
            ...
            <p className="mb-2">Product: VPS/RDP 17GB 7vCORE</p>
            <p className="mb-2">Price: RP.350.000</p>
