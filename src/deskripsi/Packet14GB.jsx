...
const Packet14GB = () => {
  ...
  const handleBuyNow = () => {
    if (!selectedOption) {
      ...
      const isPromoValid = promoCode === "KAMPANG";
      const orderDetails = {
        productName: "VPS/RDP 4GB 2vCORE",
        price: isPromoValid ? "RP.20.000" : "RP.25.000",
        selectedOS: selectedOption,
        promoApplied: isPromoValid,
      };
      setIsPromoApplied(isPromoValid);
          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            ...
            <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
              <p className="text-2xl font-extrabold text-gray-500 sm:text-3xl">
                {promoCode === "KAMPANG" ? (
                  <>
                    <del className="text-gray-400">RP.25.000</del>{" "}
                    <span className="text-gray-500">RP.20.000</span>
                  </>
                ) : (
                  "RP.25.000"
                )}
...
<div className="mt-4">
  <label className="block text-sm font-medium text-gray-500 mb-1">Enter Promo Code</label>
  <input
    type="text"
    value={promoCode}
  ...
  />
  {promoCode === "KAMPANG" && (
    <p className="text-green-600 mt-2">Promo applied! 🎉</p>
  )}
</div>
          ...
          <div className="bg-white/90 rounded-lg shadow-lg p-6 w-96">
            ...
            <div className="text-gray-600">
              ...
              <p className="mb-2">
                ...
                {isPromoApplied ? (
                  <>
                    <del className="text-gray-500">RP.25.000</del>{" "}
