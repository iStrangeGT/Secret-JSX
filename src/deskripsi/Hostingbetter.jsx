...
const Hostingbetter = () => {
  ...
  const handleBuyNow = () => {
    const orderDetails = {
      productName: "Best Hosting With 17GB 7vCore + Premium CPP",
      price: "RP.600.000",
    };
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            <h1 className="text-xl font-semibold text-blue-800 sm:text-2xl">
              [Services] <span className="text-gray-500">Best Hosting With 17GB 7vCore + Premium CPP</span>
            </h1>
            <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
              <p className="text-2xl font-extrabold text-gray-500 sm:text-3xl">RP.600.000</p>
            </div>
       ...
       >
          <div className="bg-white/90 rounded-lg shadow-lg p-6 w-96">
            ...
            <div className="text-gray-600">
              <p className="mb-2">Best Hosting With 17GB 7vCore + Premium CPP</p>
              <p className="mb-3">Price: RP.600.000</p>
            </div>
