...
const Dashboard = () => {
    return (
<>  
<div class=" flex-col items-center hidden md:flex w-48 h-full overflow-hidden min-h-screen text-gray-400 bg-white/50">
    <a class="flex items-center w-full px-14 mt-3">
<img src="/secretbiru.png" alt="kontol" />
    </a>
    <span className="text-xs flex text-center justify-center">Hi Customers!,  Welcome to SECRETSTORE #1 Digital Store.
    </span>
    <div class="w-full px-2">
      <div class="flex flex-col items-center w-full mt-3 border-t border-blue-500">
        <a class="flex items-center w-full h-12 px-3 mt-2 rounded bg-blue-800 text-white" href="#">
        ...
        <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-800 hover:text-white" href="#">
          <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a class="flex items-center w-full h-12 px-3 mt-2 hover:text-white hover:bg-blue-800 rounded" href="#">
          <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <div class="flex flex-col items-center w-full mt-2 border-t border-blue-500">
        <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-800 hover:text-white" href="#">
          <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a class="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-800 hover:text-white"
          href="#">
          <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a class="flex items-center justify-center w-full h-16 mt-auto bg-blue-800 hover:bg-blue-700 text-white"
      href="#">
      <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
