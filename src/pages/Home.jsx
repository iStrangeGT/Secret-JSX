...
<div className="flex justify-center items-center my-28 mt-10">
  <button className="px-8 py-2 rounded-full bg-blue-800 text-lg text-white hover:opacity-90 transition duration-300">
  <Link to="/dashboard">Get Started</Link>
  </button>
</div>
  ...
  <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
      ...
      <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center  text-blue-800  bg-white/50 rounded-lg border border-gray-100 shadow">
              ...
              <div class="flex justify-center items-baseline my-8">
                  <span class="mr-2 text-xl  text-blue-800 font-extrabold">RP.600.000</span>
                  <span class="text-gray-500">/month</span>
              </div>
              <ul role="list" class="mb-8  text-gray-500 space-y-4 text-left">
                  <li class="flex items-center space-x-3">
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-blue-800 bg-white/50 rounded-lg border border-gray-100 shadow">
              ...
              <div class="flex justify-center items-baseline my-8">
                  <span class="mr-2 text-blue-800 text-xl font-extrabold">RP.999.999</span>
                  <span class="text-gray-500">/month</span>
              </div>
              <ul role="list" class="mb-8  text-gray-500 space-y-4 text-left">
                  <li class="flex items-center space-x-3">
